...
<div class="live-stream mb-5">
    <div class="col-lg-12">
        <div class="heading-section">
            @if (request('search'))
                <h4><em>Hasil Pencarian Berita Kategori {{ $news_category->name }} :</em> {{ request('search') }}</h4>
            @else
                <h4><em>Berita POBSI</em> Kategori {{ $news_category->name }}</h4>
            @endif
        </div>
    </div>
    <div class="row">
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="item">
                        ...
                        <div class="down-content">
                            <span><i class="fa fa-check"></i> {{ $n->user_created_by->user_data->name }} | {{ $n->created_at }}</span>
