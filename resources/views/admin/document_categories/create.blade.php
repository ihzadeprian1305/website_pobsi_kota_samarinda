    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Tambah Data Kategori Dokumen</p>
            </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Tambah Kategori Dokumen</h4>
            </div>
            <div class="card-body">
                @if (session('status'))
                    <div class="col-sm-12">
                ...
                @endif
                <form action="{{ url('/admin/document-categories') }}" method="POST" enctype="multipart/form-data">
                    @csrf
